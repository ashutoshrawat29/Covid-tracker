...
public class App {
    ...
    /*App.printHelp(); Calling the static method directly using the class name later*/
    public static void printHelp() {
        ...
        String[] commands = { "-h", "-l", "-s all", "-s cat \"Category\"", "-s adno \"Aadhar_No\"", "-s cname \"Candidate_Name\"",
                            "-s age \"Age\" ", "-i", "-count cat \"Category\"", "-count firstdose ", "-count seconddose ",
        ...
        String[] description = { "Help for commands", "Load data.csv in MySql", "Display whole data",
                ...
                "Display data records for particular Candidate Name", "Display data records for particular age", "Insert data into the records", "Count the number of data records per category",
